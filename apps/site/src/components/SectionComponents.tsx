...
export const HeroSection = ({ label, title, description, mockup }: HeroSectionProps) => (
  <section className="relative min-h-[calc(92svh-3.5rem)] overflow-x-clip overflow-y-visible bg-background pb-4 md:pb-8">
    <div className="legacy-hero-backdrop pointer-events-none absolute inset-0" aria-hidden="true" />
    <div className="container relative flex min-h-[calc(92svh-3.5rem)] flex-col justify-center pb-0 pt-14 md:pt-20">
      <div className="mx-auto max-w-6xl text-center">
        ...
        >
          ...
          <h1 className="mx-auto mt-4 max-w-none text-4xl font-bold leading-[1.08] tracking-tight text-foreground md:text-[3.4rem] lg:whitespace-nowrap">
            {title}
          </h1>
        ...
        <div className="relative p-8 text-center md:p-12">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-md bg-primary px-6 py-2.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 focus-visible:outline-none"
            >
              {copy.primaryCta}
              <ArrowRight size={14} />
            </Link>
            <a
              ...
              className="inline-flex items-center gap-2 rounded-md border border-border px-6 py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none"
            >
              {copy.secondaryCta}
            </a>
          </div>
